...
async function main() {
  ...
  await prisma.galleryItem.createMany({
    data: [
      {
        title: 'Studio Operator Bloopers & Mixing Console Secret Tips',
        description: 'Watch RJ Ananya & Sound Tech in action during live mixing',
        type: 'VIDEO',
        mediaUrl: 'https://assets.mixkit.co/videos/preview/mixkit-radio-presenter-in-a-broadcast-studio-41584-large.mp4',
        thumbnail: 'https://images.unsplash.com/photo-1598488035139-bdbb2231ce04?auto=format&fit=crop&w=600&q=80',
        duration: '0:45 Shorts',
        album: 'Behind The Mic',
        category: 'BTS Shorts',
      },
      {
        title: 'Live Radio Broadcast Booth',
        description: 'High fidelity microphone & monitoring setup',
        type: 'PHOTO',
      ...
      {
        title: 'Campus Radio Fest Highlights',
        description: 'Outdoor broadcast stage energy and fun bloopers',
        type: 'VIDEO',
        mediaUrl: 'https://assets.mixkit.co/videos/preview/mixkit-sound-engineer-working-on-a-mixing-console-41586-large.mp4',
        thumbnail: 'https://images.unsplash.com/photo-1470225620780-dba8ba36b745?auto=format&fit=crop&w=600&q=80',
        duration: '1:15 Shorts',
        album: 'Behind The Mic',
        category: 'BTS Shorts',
      },
      {
        title: 'Morning Show Team Planning',
        description: 'RJ Vikram & Ananya planning daily topics',
        type: 'PHOTO',
      ...
      {
        title: 'Vinyl Records Vault & Modern Turntables',
        description: 'Over 5,000 vintage & modern vinyl collection',
        type: 'PHOTO',
        mediaUrl: 'https://images.unsplash.com/photo-1539375665275-f9de415ef9ac?auto=format&fit=crop&w=800&q=80',
        album: 'Behind The Mic',
        category: 'Photos',
      },
      {
        title: 'Late Night Sound Calibration & Studio Bloopers',
        description: 'Equalizer testing before Midnight Sessions',
        type: 'VIDEO',
        mediaUrl: 'https://assets.mixkit.co/videos/preview/mixkit-hands-adjusting-the-sound-on-an-equalizer-41587-large.mp4',
        thumbnail: 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?auto=format&fit=crop&w=600&q=80',
        duration: '0:30 Shorts',
        album: 'Behind The Mic',
        category: 'BTS Shorts',
      },
    ],
