...
const databaseUrl = rawDbUrl.startsWith('file:') && !path_1.default.isAbsolute(rawDbUrl.replace('file:', ''))
    ? `file:${path_1.default.resolve(__dirname, '../../prisma', rawDbUrl.replace('file:', '')).replace(/\\/g, '/')}`
    : rawDbUrl;
exports.config = {
